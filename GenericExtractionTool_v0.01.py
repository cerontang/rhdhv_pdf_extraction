...
def defineFormat ():
    sameFormat = pyautogui.confirm(text='Same formatting?', title='PDF extraction tool v0.00', buttons=['Y', 'N'])
    return sameFormat
...
def pdfExtraction (PDF_file_path, PDF, extractType, sameFormat, master_boundingbox_list):
...
if __name__ == "__main__":
    ...
    def main():
        ...
        for PDF in PDF_list:
            ...
            extractedData = pdfExtraction (PDF_file_path, PDF, extractType, sameFormat, master_boundingbox_list)
        ...
        dataframe.to_csv(f'C:/Users/921722/OneDrive - Royal HaskoningDHV/20230928 Extraction/BH logs/{csvName}.csv')
