...
groutingRecords_received_path = r'C:\Users\921722\Box\BI3753 Team\62 - Received Trojan\220419 - Pier-2, 3 and 4 Grouting Record\Pier-3 Grouting Record'
...
for fileName in groutingRecords_mainDir:
    ...
    if fileName == '73) INUNDATION-S2208 TO S2209' or fileName == '74) INUNDATION-S2210 TO S2209':
        groutingRecords_inun_path = r'C:/Users/921722/Box/BI3753 Team/62 - Received Trojan/220419 - Pier-2, 3 and 4 Grouting Record/Pier-3 Grouting Record/'+fileName
        ...
        for element in groutingRecords_inunDir:
            ...
            probe_in_nun_area_path = r'C:/Users/921722/Box/BI3753 Team/62 - Received Trojan/220419 - Pier-2, 3 and 4 Grouting Record/Pier-3 Grouting Record/' + r'/' + fileName + r'/' + element
    ...
    #LIST OUT THE PROBE IN EACH AREA, APPEND AREA NAME AS WELL TO PLUG IN DATAFRAME
    probe_in_area_path = r'C:/Users/921722/Box/BI3753 Team/62 - Received Trojan/220419 - Pier-2, 3 and 4 Grouting Record/Pier-3 Grouting Record/' + fileName
...
print(df)
df.to_csv(r'csv\P3groutingrecordsPROBELIST.csv')
