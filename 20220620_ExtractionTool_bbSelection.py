...
VBH_folder_path = r'C:\Users\921722\Box\BI3753 Team\30 - Geotech\05-Ground Investigation\OpenGround\APM HH 2022\References\20220708 Borehole Logs Draft'
...
for VBH_file in VBH_list:
    ...
    if not VBH_file.endswith('.pdf'):
        continue
    VBH_file_path = f'C:/Users/921722/Box/BI3753 Team/30 - Geotech/05-Ground Investigation/OpenGround/APM HH 2022/References/20220708 Borehole Logs Draft/{VBH_file}'
    #print(VBH_file_path)
...
dataframe.to_csv('csv\APMHH2022_GI_Description.csv')